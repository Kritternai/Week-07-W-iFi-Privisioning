...
static bool check_factory_reset_button(void)
{
    ...
    ESP_LOGI(TAG, "Hold GPIO 21 button for 3 seconds to trigger Factory Reset...");
    int hold_count = 0;
...
void app_main(void)
{
    ...
    // 1. ตรวจสอบการกดปุ่ม GPIO 21 ทางกายภาพ
    ...
    ESP_LOGW(TAG, "[MENUCONFIG]: CONFIG_EXAMPLE_RESET_PROVISIONED is enabled! Erasing NVS Flash...");
    ESP_ERROR_CHECK(nvs_flash_erase());
#endif
